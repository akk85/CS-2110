...
class CsvEvaluatorTest {
    ...
    @Test
    @DisplayName("Formulas with known function applications should evaluate correctly.")
    void testEvaluateCsvKnownFunctions() throws IOException {
        String input = "x,1.5\n" +
                "y,=B1 4 * 1 +\n" +
                "z,=B1 B2 +\n";
        String expected = "x,1.5\n"
    ...
    @Test
    @DisplayName("Formulas with unknown function applications should evaluate to #N/A.")
    void testEvaluateCsvUnknownFunctions() throws IOException {
        String input = "x,1.5\n" +
                "y,=UNKNOWN_FUNCTION(B1)\n";
        String expected = "x,1.5\n"
                + "y,#N/A\n";
    ...
    @Test
    @DisplayName("Formulas referencing future cells should evaluate to #N/A.")
    void testEvaluateCsvFutureCellRef() throws IOException {
        String input = "x,=B2\n" +
                "y,1.5\n";
    ...
    void testEvaluateCsvOutOfBoundsCellRef() throws IOException {
        String input = "x,=Z100\n";
        String expected = "x,#N/A\n";
    ...
    @Test
    @DisplayName("Formulas with variables that do not correspond to a cell coordinate should evaluate to #N/A.")
    void testEvaluateCsvInvalidVariableRef() throws IOException {
        String input = "x,=INVALID_VAR\n";
        String expected = "x,#N/A\n";
    ...
    @Test
    @DisplayName("Formulas containing an incomplete RPN expression should evaluate to #N/A.")
    ...
    @Test
    public void testCsvEvaluatorWithPizzaCsv() throws IOException {

        // Evaluate CSV file and print output
        try (FileReader reader = new FileReader("pizza.csv");
                CSVParser parser = CsvEvaluator.SIMPLIFIED_CSV.parse(reader)) {
            // Print results directly to System.out
            CSVPrinter resultPrinter = CsvEvaluator.SIMPLIFIED_CSV.printer();
            CsvEvaluator.evaluateCsv(parser, resultPrinter);
